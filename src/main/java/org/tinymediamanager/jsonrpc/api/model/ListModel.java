...
public final class ListModel {
  ...
  public static class FilterRule extends AbstractModel {
    ...
    /**
     * @param operator
     *          One of: <tt>contains</tt>, <tt>doesnotcontain</tt>, <tt>is</tt>, <tt>isnot</tt>, <tt>startswith</tt>, <tt>endswith</tt>,
     *          <tt>greaterthan</tt>, <tt>lessthan</tt>, <tt>after</tt>, <tt>before</tt>, <tt>inthelast</tt>, <tt>notinthelast</tt>, <tt>true</tt>,
     *          <tt>false</tt>, <tt>between</tt>. See constants at {@link ListModel.FilterRule.Operator}.
     * @param value
     */
    ...
    public interface Operator {
      ...
      public final static Set<String> values         = new HashSet<String>(Arrays.asList(CONTAINS, DOESNOTCONTAIN, IS, ISNOT, STARTSWITH, ENDSWITH,
          GREATERTHAN, LESSTHAN, AFTER, BEFORE, INTHELAST, NOTINTHELAST, TRUE, FALSE, BETWEEN));
    }
  }
  ...
  public static class AlbumFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>genre</tt>, <tt>album</tt>, <tt>artist</tt>, <tt>albumartist</tt>, <tt>year</tt>, <tt>review</tt>, <tt>themes</tt>,
     *          <tt>moods</tt>, <tt>styles</tt>, <tt>type</tt>, <tt>label</tt>, <tt>rating</tt>, <tt>playcount</tt>, <tt>playlist</tt>,
     *          <tt>virtualfolder</tt>. See constants at {@link ListModel.AlbumFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values        = new HashSet<String>(Arrays.asList(GENRE, ALBUM, ARTIST, ALBUMARTIST, YEAR, REVIEW, THEMES,
          MOODS, STYLES, TYPE, LABEL, RATING, PLAYCOUNT, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class ArtistFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>artist</tt>, <tt>genre</tt>, <tt>moods</tt>, <tt>styles</tt>, <tt>instruments</tt>, <tt>biography</tt>, <tt>born</tt>,
     *          <tt>bandformed</tt>, <tt>disbanded</tt>, <tt>died</tt>, <tt>playlist</tt>, <tt>virtualfolder</tt>. See constants at
     *          {@link ListModel.ArtistFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values        = new HashSet<String>(
          Arrays.asList(ARTIST, GENRE, MOODS, STYLES, INSTRUMENTS, BIOGRAPHY, BORN, BANDFORMED, DISBANDED, DIED, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class EpisodeFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>title</tt>, <tt>tvshow</tt>, <tt>plot</tt>, <tt>votes</tt>, <tt>rating</tt>, <tt>time</tt>, <tt>writers</tt>,
     *          <tt>airdate</tt>, <tt>playcount</tt>, <tt>lastplayed</tt>, <tt>inprogress</tt>, <tt>genre</tt>, <tt>year</tt>, <tt>director</tt>,
     *          <tt>actor</tt>, <tt>episode</tt>, <tt>season</tt>, <tt>filename</tt>, <tt>path</tt>, <tt>studio</tt>, <tt>mpaarating</tt>,
     *          <tt>dateadded</tt>, <tt>tag</tt>, <tt>videoresolution</tt>, <tt>audiochannels</tt>, <tt>videocodec</tt>, <tt>audiocodec</tt>,
     *          <tt>audiolanguage</tt>, <tt>subtitlelanguage</tt>, <tt>videoaspect</tt>, <tt>playlist</tt>, <tt>virtualfolder</tt>. See constants at
     *          {@link ListModel.EpisodeFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values           = new HashSet<String>(Arrays.asList(TITLE, TVSHOW, PLOT, VOTES, RATING, TIME, WRITERS, AIRDATE,
          PLAYCOUNT, LASTPLAYED, INPROGRESS, GENRE, YEAR, DIRECTOR, ACTOR, EPISODE, SEASON, FILENAME, PATH, STUDIO, MPAARATING, DATEADDED, TAG,
          VIDEORESOLUTION, AUDIOCHANNELS, VIDEOCODEC, AUDIOCODEC, AUDIOLANGUAGE, SUBTITLELANGUAGE, VIDEOASPECT, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class MovieFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>title</tt>, <tt>plot</tt>, <tt>plotoutline</tt>, <tt>tagline</tt>, <tt>votes</tt>, <tt>rating</tt>, <tt>time</tt>,
     *          <tt>writers</tt>, <tt>playcount</tt>, <tt>lastplayed</tt>, <tt>inprogress</tt>, <tt>genre</tt>, <tt>country</tt>, <tt>year</tt>,
     *          <tt>director</tt>, <tt>actor</tt>, <tt>mpaarating</tt>, <tt>top250</tt>, <tt>studio</tt>, <tt>hastrailer</tt>, <tt>filename</tt>,
     *          <tt>path</tt>, <tt>set</tt>, <tt>tag</tt>, <tt>dateadded</tt>, <tt>videoresolution</tt>, <tt>audiochannels</tt>, <tt>videocodec</tt>,
     *          <tt>audiocodec</tt>, <tt>audiolanguage</tt>, <tt>subtitlelanguage</tt>, <tt>videoaspect</tt>, <tt>playlist</tt>,
     *          <tt>virtualfolder</tt>. See constants at {@link ListModel.MovieFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values           = new HashSet<String>(
          Arrays.asList(TITLE, PLOT, PLOTOUTLINE, TAGLINE, VOTES, RATING, TIME, WRITERS, PLAYCOUNT, LASTPLAYED, INPROGRESS, GENRE, COUNTRY, YEAR,
              DIRECTOR, ACTOR, MPAARATING, TOP250, STUDIO, HASTRAILER, FILENAME, PATH, SET, TAG, DATEADDED, VIDEORESOLUTION, AUDIOCHANNELS,
              VIDEOCODEC, AUDIOCODEC, AUDIOLANGUAGE, SUBTITLELANGUAGE, VIDEOASPECT, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class MusicVideoFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>title</tt>, <tt>genre</tt>, <tt>album</tt>, <tt>year</tt>, <tt>artist</tt>, <tt>filename</tt>, <tt>path</tt>,
     *          <tt>playcount</tt>, <tt>lastplayed</tt>, <tt>time</tt>, <tt>director</tt>, <tt>studio</tt>, <tt>plot</tt>, <tt>tag</tt>,
     *          <tt>dateadded</tt>, <tt>videoresolution</tt>, <tt>audiochannels</tt>, <tt>videocodec</tt>, <tt>audiocodec</tt>, <tt>audiolanguage</tt>
     *          , <tt>subtitlelanguage</tt>, <tt>videoaspect</tt>, <tt>playlist</tt>, <tt>virtualfolder</tt>. See constants at
     *          {@link ListModel.MusicVideoFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values           = new HashSet<String>(
          Arrays.asList(TITLE, GENRE, ALBUM, YEAR, ARTIST, FILENAME, PATH, PLAYCOUNT, LASTPLAYED, TIME, DIRECTOR, STUDIO, PLOT, TAG, DATEADDED,
              VIDEORESOLUTION, AUDIOCHANNELS, VIDEOCODEC, AUDIOCODEC, AUDIOLANGUAGE, SUBTITLELANGUAGE, VIDEOASPECT, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class SongFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>genre</tt>, <tt>album</tt>, <tt>artist</tt>, <tt>albumartist</tt>, <tt>title</tt>, <tt>year</tt>, <tt>time</tt>,
     *          <tt>tracknumber</tt>, <tt>filename</tt>, <tt>path</tt>, <tt>playcount</tt>, <tt>lastplayed</tt>, <tt>rating</tt>, <tt>comment</tt>,
     *          <tt>moods</tt>, <tt>playlist</tt>, <tt>virtualfolder</tt>. See constants at {@link ListModel.SongFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values        = new HashSet<String>(Arrays.asList(GENRE, ALBUM, ARTIST, ALBUMARTIST, TITLE, YEAR, TIME,
          TRACKNUMBER, FILENAME, PATH, PLAYCOUNT, LASTPLAYED, RATING, COMMENT, MOODS, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class TVShowFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>title</tt>, <tt>plot</tt>, <tt>status</tt>, <tt>votes</tt>, <tt>rating</tt>, <tt>year</tt>, <tt>genre</tt>,
     *          <tt>director</tt>, <tt>actor</tt>, <tt>numepisodes</tt>, <tt>numwatched</tt>, <tt>playcount</tt>, <tt>path</tt>, <tt>studio</tt>,
     *          <tt>mpaarating</tt>, <tt>dateadded</tt>, <tt>lastplayed</tt>, <tt>inprogress</tt>, <tt>tag</tt>, <tt>playlist</tt>,
     *          <tt>virtualfolder</tt>. See constants at {@link ListModel.TVShowFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values        = new HashSet<String>(Arrays.asList(TITLE, PLOT, STATUS, VOTES, RATING, YEAR, GENRE, DIRECTOR,
          ACTOR, NUMEPISODES, NUMWATCHED, PLAYCOUNT, PATH, STUDIO, MPAARATING, DATEADDED, LASTPLAYED, INPROGRESS, TAG, PLAYLIST, VIRTUALFOLDER));
    }
  }
  ...
  public static class TextureFilterRule extends FilterRule {
     ...
     * @param value
     * @param field
     *          One of: <tt>textureid</tt>, <tt>url</tt>, <tt>cachedurl</tt>, <tt>lasthashcheck</tt>, <tt>imagehash</tt>, <tt>width</tt>,
     *          <tt>height</tt>, <tt>usecount</tt>, <tt>lastused</tt>. See constants at {@link ListModel.TextureFilterRule.Field}.
     */
    ...
    public interface Field {
      ...
      public final static Set<String> values        = new HashSet<String>(
          Arrays.asList(TEXTUREID, URL, CACHEDURL, LASTHASHCHECK, IMAGEHASH, WIDTH, HEIGHT, USECOUNT, LASTUSED));
    }
  }
  ...
  public static class AllItems extends BaseItem {
     ...
     * 
     * @param node
     *          JSON object representing a AllItems object
     */
  ...
  public static class BaseItem extends AbstractModel {
     ...
     *          One of: <tt>album</tt>, <tt>single</tt>. See constants at {@link ListModel.BaseItem.Albumreleasetype}.
     * @param art
     * @param artist
     * @param artistid
     * @param cast
     ...
     * @param rating
     * @param releasetype
     *          One of: <tt>album</tt>, <tt>single</tt>. See constants at {@link ListModel.BaseItem.Releasetype}.
     * @param resume
     * @param runtime
     * @param season
     * @param set
     ...
     *          See constants at {@link ListModel.BaseItem.Type}.
     * @param uniqueid
     * @param votes
     ...
     * @param year
     */
    public BaseItem(String album, List<String> albumartist, List<Integer> albumartistid, Integer albumid, String albumlabel, String albumreleasetype,
        MediaModel.Artwork art, List<String> artist, List<Integer> artistid, List<VideoModel.Cast> cast, String comment, Boolean compilation,
        List<String> country, String dateadded, String description, List<String> director, Integer disc, String displayartist, Integer duration,
        Integer episode, String episodeguide, String fanart, String file, String firstaired, List<String> genre, List<Integer> genreid, Integer id,
        String imdbnumber, String label, String lastplayed, String lyrics, List<String> mood, String mpaa, String musicbrainzalbumartistid,
        String musicbrainzalbumid, String musicbrainzartistid, String musicbrainztrackid, String originaltitle, Integer playcount, String plot,
        String plotoutline, String premiered, String productioncode, Integer rating, String releasetype, VideoModel.Resume resume, Integer runtime,
        Integer season, String set, Integer setid, List<String> showlink, String showtitle, String sorttitle, Integer specialsortepisode,
        Integer specialsortseason, VideoModel.Streams streamdetails, List<String> studio, List<String> style, List<String> tag, String tagline,
        List<String> theme, String thumbnail, String title, Integer top250, Integer track, String trailer, Integer tvshowid, String type,
        HashMap<String, String> uniqueid, String votes, Integer watchedepisodes, List<String> writer, Integer year) {
      this.album = album;
     ...
     * 
     * @param node
     *          JSON object representing a BaseItem object
     */
  ...
  public static class FileItem extends BaseItem {
     ...
     * 
     * @param node
     *          JSON object representing a FileItem object
     */
  ...
  public static class SourceItem extends ItemModel.BaseDetail {
     ...
     * 
     * @param node
     *          JSON object representing a SourceItem object
     */
  ...
  public static class LimitsReturned extends AbstractModel {
     ...
     * 
     * @param node
     *          JSON object representing a LimitsReturned object
     */
  ...
  public static class Sort extends AbstractModel {
     ...
     * @param ignorearticle
     * @param method
     *          One of: <tt>none</tt>, <tt>label</tt>, <tt>date</tt>, <tt>size</tt>, <tt>file</tt>, <tt>path</tt>, <tt>drivetype</tt>, <tt>title</tt>,
     *          <tt>track</tt>, <tt>time</tt>, <tt>artist</tt>, <tt>album</tt>, <tt>albumtype</tt>, <tt>genre</tt>, <tt>country</tt>, <tt>year</tt>,
     *          <tt>rating</tt>, <tt>votes</tt>, <tt>top250</tt>, <tt>programcount</tt>, <tt>playlist</tt>, <tt>episode</tt>, <tt>season</tt>,
     *          <tt>totalepisodes</tt>, <tt>watchedepisodes</tt>, <tt>tvshowstatus</tt>, <tt>tvshowtitle</tt>, <tt>sorttitle</tt>,
     *          <tt>productioncode</tt>, <tt>mpaa</tt>, <tt>studio</tt>, <tt>dateadded</tt>, <tt>lastplayed</tt>, <tt>playcount</tt>,
     *          <tt>listeners</tt>, <tt>bitrate</tt>, <tt>random</tt>. See constants at {@link ListModel.Sort.Method}.
     * @param order
     *          One of: <tt>ascending</tt>, <tt>descending</tt>. See constants at {@link ListModel.Sort.Order}.
     */
    ...
    public interface Method {
      ...
      public final static Set<String> values          = new HashSet<String>(
          Arrays.asList(NONE, LABEL, DATE, SIZE, FILE, PATH, DRIVETYPE, TITLE, TRACK, TIME, ARTIST, ALBUM, ALBUMTYPE, GENRE, COUNTRY, YEAR, RATING,
              VOTES, TOP250, PROGRAMCOUNT, PLAYLIST, EPISODE, SEASON, TOTALEPISODES, WATCHEDEPISODES, TVSHOWSTATUS, TVSHOWTITLE, SORTTITLE,
              PRODUCTIONCODE, MPAA, STUDIO, DATEADDED, LASTPLAYED, PLAYCOUNT, LISTENERS, BITRATE, RANDOM));
    }
  }
  ...
  public interface AllFields {
    ...
    public final static Set<String> values                   = new HashSet<String>(Arrays.asList(TITLE, ARTIST, ALBUMARTIST, GENRE, YEAR, RATING,
        ALBUM, TRACK, DURATION, COMMENT, LYRICS, MUSICBRAINZTRACKID, MUSICBRAINZARTISTID, MUSICBRAINZALBUMID, MUSICBRAINZALBUMARTISTID, PLAYCOUNT,
        FANART, DIRECTOR, TRAILER, TAGLINE, PLOT, PLOTOUTLINE, ORIGINALTITLE, LASTPLAYED, WRITER, STUDIO, MPAA, CAST, COUNTRY, IMDBNUMBER, PREMIERED,
        PRODUCTIONCODE, RUNTIME, SET, SHOWLINK, STREAMDETAILS, TOP250, VOTES, FIRSTAIRED, SEASON, EPISODE, SHOWTITLE, THUMBNAIL, FILE, RESUME,
        ARTISTID, ALBUMID, TVSHOWID, SETID, WATCHEDEPISODES, DISC, TAG, ART, GENREID, DISPLAYARTIST, ALBUMARTISTID, DESCRIPTION, THEME, MOOD, STYLE,
        ALBUMLABEL, SORTTITLE, EPISODEGUIDE, UNIQUEID, DATEADDED, CHANNEL, CHANNELTYPE, HIDDEN, LOCKED, CHANNELNUMBER, STARTTIME, ENDTIME,
        SPECIALSORTSEASON, SPECIALSORTEPISODE, COMPILATION, RELEASETYPE, ALBUMRELEASETYPE));
  }
  ...
  public interface FileFields {
    ...
    public final static Set<String> values                   = new HashSet<String>(Arrays.asList(TITLE, ARTIST, ALBUMARTIST, GENRE, YEAR, RATING,
        ...
        PRODUCTIONCODE, RUNTIME, SET, SHOWLINK, STREAMDETAILS, TOP250, VOTES, FIRSTAIRED, SEASON, EPISODE, SHOWTITLE, THUMBNAIL, FILE, RESUME,
        ARTISTID, ALBUMID, TVSHOWID, SETID, WATCHEDEPISODES, DISC, TAG, ART, GENREID, DISPLAYARTIST, ALBUMARTISTID, DESCRIPTION, THEME, MOOD, STYLE,
        ALBUMLABEL, SORTTITLE, EPISODEGUIDE, UNIQUEID, DATEADDED, SIZE, LASTMODIFIED, MIMETYPE, SPECIALSORTSEASON, SPECIALSORTEPISODE));
  }
  ...
  public interface AlbumFilterFields {
    ...
    public final static Set<String> values        = new HashSet<String>(Arrays.asList(GENRE, ALBUM, ARTIST, ALBUMARTIST, YEAR, REVIEW, THEMES, MOODS,
        STYLES, TYPE, LABEL, RATING, PLAYCOUNT, PLAYLIST, VIRTUALFOLDER));
  }
  ...
  public interface MovieFilterFields {
    ...
    public final static Set<String> values           = new HashSet<String>(
        Arrays.asList(TITLE, PLOT, PLOTOUTLINE, TAGLINE, VOTES, RATING, TIME, WRITERS, PLAYCOUNT, LASTPLAYED, INPROGRESS, GENRE, COUNTRY, YEAR,
            DIRECTOR, ACTOR, MPAARATING, TOP250, STUDIO, HASTRAILER, FILENAME, PATH, SET, TAG, DATEADDED, VIDEORESOLUTION, AUDIOCHANNELS, VIDEOCODEC,
            AUDIOCODEC, AUDIOLANGUAGE, SUBTITLELANGUAGE, VIDEOASPECT, PLAYLIST, VIRTUALFOLDER));
  }
