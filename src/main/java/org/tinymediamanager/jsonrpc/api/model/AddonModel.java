...
public final class AddonModel {
  ...
  public static class Detail extends ItemModel.BaseDetail {
     ...
     * 
     * @param node
     *          JSON object representing a Detail object
     */
    ...
    public static class Broken extends AbstractModel {
       ...
       * 
       * @param node
       *          JSON object representing a Broken object
       */
    ...
    public static class Dependency extends AbstractModel {
       ...
       * 
       * @param node
       *          JSON object representing a Dependency object
       */
    ...
    public static class Extrainfo extends AbstractModel {
       ...
       * 
       * @param node
       *          JSON object representing a Extrainfo object
       */
  ...
  public interface Fields {
    ...
    public final static Set<String> values       = new HashSet<String>(Arrays.asList(NAME, VERSION, SUMMARY, DESCRIPTION, PATH, AUTHOR, THUMBNAIL,
        DISCLAIMER, FANART, DEPENDENCIES, BROKEN, EXTRAINFO, RATING, ENABLED));
  }
