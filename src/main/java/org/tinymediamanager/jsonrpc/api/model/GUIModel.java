...
public final class GUIModel {
  ...
  public static class StereoscopyMode extends AbstractModel {
     ...
     * @param label
     * @param mode
     *          One of: <tt>off</tt>, <tt>split_vertical</tt>, <tt>split_horizontal</tt>, <tt>row_interleaved</tt>, <tt>hardware_based</tt>,
     *          <tt>anaglyph_cyan_red</tt>, <tt>anaglyph_green_magenta</tt>, <tt>anaglyph_yellow_blue</tt>, <tt>monoscopic</tt>. See constants at
    ...
    public interface Mode {
      ...
      public final static Set<String> values                 = new HashSet<String>(Arrays.asList(OFF, SPLIT_VERTICAL, SPLIT_HORIZONTAL,
  ...
  public interface Window {
    ...
    public final static Set<String> values                  = new HashSet<String>(Arrays.asList(HOME, PROGRAMS, PICTURES, FILEMANAGER, FILES,
