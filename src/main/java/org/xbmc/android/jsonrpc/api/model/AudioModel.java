...
public final class AudioModel {
  ...
  public static class AlbumDetail extends MediaDetail {
     ...
     * 
     * @param node
     *          JSON object representing a AlbumDetail object
     */
  ...
  public static class ArtistDetail extends BaseDetail {
     ...
     * 
     * @param node
     *          JSON object representing a ArtistDetail object
     */
  ...
  public static class SongDetail extends MediaDetail {
     ...
     * 
     * @param node
     *          JSON object representing a SongDetail object
     */
  ...
  public interface AlbumFields {
    ...
    public final static Set<String> values                   = new HashSet<String>(
        Arrays.asList(TITLE, DESCRIPTION, ARTIST, GENRE, THEME, MOOD, STYLE, TYPE, ALBUMLABEL, RATING, YEAR, MUSICBRAINZALBUMID,
            MUSICBRAINZALBUMARTISTID, FANART, THUMBNAIL, PLAYCOUNT, GENREID, ARTISTID, DISPLAYARTIST, COMPILATION, RELEASETYPE, DATEADDED));
  }
  ...
  public interface ArtistFields {
    ...
    public final static Set<String> values              = new HashSet<String>(Arrays.asList(INSTRUMENT, STYLE, MOOD, BORN, FORMED, DESCRIPTION, GENRE,
        DIED, DISBANDED, YEARSACTIVE, MUSICBRAINZARTISTID, FANART, THUMBNAIL, COMPILATIONARTIST, DATEADDED));
  }
  ...
  public interface SongFields {
    ...
    public final static Set<String> values                   = new HashSet<String>(Arrays.asList(TITLE, ARTIST, ALBUMARTIST, GENRE, YEAR, RATING,
        ...
        FANART, THUMBNAIL, FILE, ALBUMID, LASTPLAYED, DISC, GENREID, ARTISTID, DISPLAYARTIST, ALBUMARTISTID, ALBUMRELEASETYPE, DATEADDED));
  }
}
