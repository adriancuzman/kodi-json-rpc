...
public final class FavouriteModel {
  ...
  public static class FavouriteDetail extends AbstractModel {
     ...
     * @param title
     * @param type
     *          One of: <tt>media</tt>, <tt>window</tt>, <tt>script</tt>, <tt>unknown</tt>. See constants at
     *          {@link FavouriteModel.FavouriteDetail.Type}.
     * @param window
     ...
     * 
     * @param node
     *          JSON object representing a FavouriteDetail object
     */
